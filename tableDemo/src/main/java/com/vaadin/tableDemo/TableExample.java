...
public class TableExample extends CustomComponent  {
    ...
    public static final String[]  contextType = {"basic","singleselect","multiselect","components",
    		"nestedtables","interactingcomponents","beancomponents","layouts","reversebyindex","editable",
    		"buffering","spreadsheet","editableheights","combobox","ratios","generatedcolumn","headers",
    		"fakeheaders","htmlheaders","footer-basic","footer-sum","headerclick","rowheaders","contextmenu",
    		"filtering","columnresize","columnreordering","columncollapsing","propertyformatter","columnformatting-simple",
    		"columnformatting-extended","cellstylegenerator","cssinjection","varyingrows","varyingheightlabels","cellrenderer",
    		"editorform","scrolltoitem","removeallitems","detailsshrink"
    };
    
    public TableExample(String context){
    	init(context);
    }
...
//        editable.setColumnHeader("name", "Name Cus");
    ...
    void editableHeights() {
        ...
        Object people[][] = {
            ...
            {new GregorianCalendar(1891, 0, 0).getTime(), "Finnish", "V瓣is瓣l瓣"},
